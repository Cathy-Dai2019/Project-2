...
| --- | --- | --- |
| IMDB Starter Code | Project Prompts and Description | [Here](./project-eda-imdb.ipynb) |
| IMDB Dataset | IMDB Dataset | [Here](./data/imdb_1000.csv) |
| IMDB Solution Code | Sample solutions for project questions | Here |
| --- | --- | --- |
| Bonus: Chipotle Starter Code | Project Prompts and Description | [Here](./project-eda-chipotle.ipynb) |
| Bonus: Chipotle Dataset | Dataset File | [Here](./data/chipotle.tsv) |
| Bonus: Chipotle Solution Code | Sample solutions for project questions | Here |
...
For this project, you're required to complete the IMDB project. To further practice your Python programming, you can complete the bonus Chipotle project.
...
Your instructor will explain how to submit your assignment.
 ...
 - Creating a new repository for this project in your github profile
 - A google form will be sent via email on Wednesday to collect your github project link